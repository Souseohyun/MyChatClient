...
CreateGroupWnd::CreateGroupWnd() : QDialog ()
{
    ...
    logo->setPixmap(QPixmap(":/Icons/MainWindow/group_chat.png").
    ...
    nameEdit->setStyleSheet("background:transparent;color:black;border:1px solid white;border-style:outset");
    ...
    palette.setBrush(QPalette::Window,QBrush(QPixmap(":/Icons/MainWindow/back3.png").
...
void CreateGroupWnd::sltCreate()
{
    ...
    if(text.isEmpty()){
        ...
        if(text.size() > 20){
            ...
            nlohmann::json json;
            json["adminID"] = MyConfig::userId;
            json["name"] = text.toStdString();
